defmodule BotArmyInbox.Skills.Example do
  @moduledoc """
  Example skill for Inbox Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_inbox.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_inbox.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_inbox/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_inbox.command.example"
    ]
  end
